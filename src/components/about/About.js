...
import Map_employee from "../map_employees/Map_employee";
    ...
    <div>
      <div className="background">
        ...
        <div className="portal_details">
          ...
          stacji medycznych, zgłoszeń medycznych oraz pracowników stacji, a
          także ułatwienie ich wizualizacji, analizy i wykorzystania w
          codziennej pracy oraz w podejmowaniu strategicznych decyzji.
          <p>
            ...
            <p>
              ...
              zgodnie z potrzebami użytkownika. Każda warstwa zawiera
              szczegółowe informacje na temat obiektów, takich jak stacje
              medyczne, zgłoszenia medyczne oraz pracownicy stacji.{" "}
            </p>{" "}
            ...
            <p>
              ...
              użytkownikom na przeglądanie i analizowanie danych przestrzennych
              w intuicyjny sposób. Możesz korzystać z różnych podkładów
              mapowych, takich jak OpenStreetMap, Google Satellite czy
              OpenTopoMap, aby dostosować widok mapy do swoich potrzeb.{" "}
            </p>
          </p>
